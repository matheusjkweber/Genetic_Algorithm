...
public abstract class Population {
	...
	public Chromosome create_chromosome(int position){
		...
		if(parameters.getFixed_genes()[2] > 0){
			hg.setFixed_value(parameters.getFixed_genes()[2]);
			hg.setValue(parameters.getFixed_genes()[2]);
		}
		
		if(parameters.getFixed_genes()[3] > 0){
			l.setFixed_value(parameters.getFixed_genes()[3]);
			l.setValue(parameters.getFixed_genes()[3]);
		}
		
		if(parameters.getFixed_genes()[1] > 0){
			q.setFixed_value(parameters.getFixed_genes()[1]);
			q.setValue(parameters.getFixed_genes()[1]);
		}
